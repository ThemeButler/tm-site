...
function tbr_welcome() { ?>
  ...
  <div class="tm-welcome uk-block uk-contrast uk-margin-large-top uk-float-left uk-width-1-1">
    <h1 class="uk-article-title uk-text-center">Premium WordPress Themes. <strong>For Free!</strong></h1>
...
function tbr_home_themes_loop( $query ) {
  ...
  <div class="uk-grid uk-grid-width-1-1 uk-grid-width-small-1-1 uk-grid-width-large-1-2" >
