...
function get_liked_icon() {
	...
	$icon = '<span class="tm-icon"><svg width="12px" height="11px" viewBox="0 0 12 11" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
	    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
	        <path d="M10.2473311,0.535591787 C9.76148185,0.267931768 9.20422023,0.114 8.60968519,0.114 C7.56071412,0.114 6.62131468,0.592012992 6.00102212,1.34157007 C5.37779948,0.592012992 4.43928588,0.114 3.38888384,0.114 C2.79577977,0.114 2.23954027,0.267931768 1.75260074,0.535591787 C0.70785445,1.11418171 0,2.22659256 0,3.50499623 C0,3.87098451 0.0595557171,4.22198165 0.167423795,4.55035579 C0.749148231,7.16521973 6.00102212,10.4630665 6.00102212,10.4630665 C6.00102212,10.4630665 11.2494208,7.16528788 11.8319629,4.55035579 C11.939831,4.22198165 12,3.87050752 12,3.50499623 C12,2.22706955 11.2921456,1.11499941 10.2473311,0.535591787 L10.2473311,0.535591787 Z" id="heart" fill="#E36817" sketch:type="MSShapeGroup"></path>
	    </g>
	</svg></span>';
	return $icon;
} // get_liked_icon()
...
function get_unliked_icon() {
	...
	$icon = '<span class="tm-icon"><svg width="12px" height="11px" viewBox="0 0 12 11" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
	    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
	        <path d="M10.2473311,0.535591787 C9.76148185,0.267931768 9.20422023,0.114 8.60968519,0.114 C7.56071412,0.114 6.62131468,0.592012992 6.00102212,1.34157007 C5.37779948,0.592012992 4.43928588,0.114 3.38888384,0.114 C2.79577977,0.114 2.23954027,0.267931768 1.75260074,0.535591787 C0.70785445,1.11418171 0,2.22659256 0,3.50499623 C0,3.87098451 0.0595557171,4.22198165 0.167423795,4.55035579 C0.749148231,7.16521973 6.00102212,10.4630665 6.00102212,10.4630665 C6.00102212,10.4630665 11.2494208,7.16528788 11.8319629,4.55035579 C11.939831,4.22198165 12,3.87050752 12,3.50499623 C12,2.22706955 11.2921456,1.11499941 10.2473311,0.535591787 L10.2473311,0.535591787 Z" id="heart" fill="#C8C8C8" sketch:type="MSShapeGroup"></path>
	    </g>
	</svg></span>';
	return $icon;
} // get_unliked_icon()
...
function show_user_likes( $user ) { ?>
	<table class="form-table">
		<tr>
			<th><label for="user_likes"><?php _e( 'You Like:', 'tbr' ); ?></label></th>
			<td>
			<?php
			...
			<?php else : ?>
			<p><?php _e( 'You do not like anything yet.', 'tbr' ); ?></p>
			<?php
			endif;
			wp_reset_postdata();
			?>
